            ...
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/tasks')); ?>">Comenzi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>"> Produse</a>
                    </li>
                  </ul>
                     ...
                     <div class="dropdown-menu">
                        ...
                        <div class="row cart-detail">
                           <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                              <img src="<?php echo e($details['photo']); ?>" width="50px"/>
                           </div>
...
<?php /**PATH C:\wamp64\www\eShop\resources\views/layoutcos.blade.php ENDPATH**/ ?>